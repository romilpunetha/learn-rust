...
impl User {
  pub fn new<F4, F5, F6, F8, F10>(id: i64, username: String, email: String, full_name: F4, bio: F5, profile_picture_url: F6, created_time: i64, last_active_time: F8, is_verified: bool, location: F10) -> User where F4: Into<Option<String>>, F5: Into<Option<String>>, F6: Into<Option<String>>, F8: Into<Option<i64>>, F10: Into<Option<String>> {
    User {
      id,
      username,
      email,
...
impl TSerializable for User {
  fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<User> {
    ...
    verify_required_field_exists("User.username", &f_2)?;
    verify_required_field_exists("User.email", &f_3)?;
    verify_required_field_exists("User.created_time", &f_7)?;
    verify_required_field_exists("User.is_verified", &f_9)?;
    let ret = User {
      ...
      created_time: f_7.expect("auto-generated code should have checked for presence of required fields"),
  ...
  fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    ...
    o_prot.write_field_begin(&TFieldIdentifier::new("created_time", TType::I64, 7))?;
